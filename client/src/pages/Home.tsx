          ...
          >
            ...
            >
              <div className="relative gradient-border rounded-2xl p-1">
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 bg-background rounded-xl p-2 sm:p-2 hero-input-wrapper">
                  {/* Instagram Icon Button */}
                  <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-gradient-to-br from-pink-500 via-purple-500 to-orange-500 shrink-0 instagram-icon">
                  ...
                  <div className="flex-1 relative">
                    <Input
                      ...
                      className="h-12 sm:h-14 text-base sm:text-lg bg-transparent border-0 focus-visible:ring-0 input-glow"
                    />
                  </div>
                  <Button 
                    onClick={handleAnalyze}
                    size="lg"
                    className="btn-gradient h-12 px-4 sm:px-8 text-white border-0 w-full sm:w-auto"
                  >
                    {t.hero.cta}
