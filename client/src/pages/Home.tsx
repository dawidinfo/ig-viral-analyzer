            ...
            >
              <div className="relative gradient-border rounded-2xl p-1">
                <div className="flex items-center gap-2 bg-background rounded-xl p-2">
                  ...
                  <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-br from-pink-500 via-purple-500 to-orange-500 shrink-0">
                  ...
                  <div className="flex-1 relative">
                    <Input
                      ...
                      className="h-14 text-lg bg-transparent border-0 focus-visible:ring-0 input-glow"
                    />
                  </div>
                  <Button 
